...
public class RecordComparator {
    ...
    public double compare(String[] tuple1, String[] tuple2) {
        ...
        for (AttrSimWeight attrSimWeight : attrSimWeights) {
            ...
            // Calculate the similarity of the attributes in the tuples using the specified similarity measure
            double attributeSimilarity = similarityMeasure.calculate(tuple1[attributeIndex], tuple2[attributeIndex]);

            // Add the weighted similarity to the overall record similarity
